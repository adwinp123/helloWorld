...
with app.app_context():
    ...
    users = [
        ...
        # modified information for student user with password hash
        {'username':'apaul123','email':'apaul123@umd.edu','first_name':'Adwin','last_name':'Paul',
         'password': generate_password_hash('meat1234', method='sha256'), 'role': 'STUDENT'}
    ]
